...
<?php endif ?>  
        ...
        <div class="main_container">
            <h1 class="signup">Add Fertilizers</h1>
        <div class="row">
            ...
            <form class="row g-3" method="POST" enctype="multipart/form-data">
                ...
                <div class="col-12">
                  ...
                  <a style= margin:30px;  href="viewfert.php"  > Back to View page  </a>
                </div>
 ...
 $image=$_POST['image'];
     ...
     $sql2="INSERT INTO fertilizers(name,quantity,price,image) values('$name','$qt','$price','$image')";
