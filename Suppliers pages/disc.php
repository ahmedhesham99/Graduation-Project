...
<th> <h2> Discount </h2><td>
<th> <h2> For sendings </h2> <th>
<th> <h2> Status </h2><th>
...
$query=" SELECT * FROM discount WHERE user_id=$id ORDER BY status ";
...
<tr style="color:white;font-size:25px;">
 ...
 <td> <a style="color:red;text-decoration:none;" href="discdetails.php?id=<?php echo $data['wasteid'];?>" > View Details</a> <td>
