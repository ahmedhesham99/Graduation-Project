...
<body>
    ...
    <button  style= margin-left:80%; type="button" class="back_btn"><a style="color:red;text-decoration:none;" href="crops.php">Back to shopping</a></button>
...
$records = mysqli_query($db,"SELECT * FROM cropss WHERE id ='$id'");
...
<form style="color:white; font-size:20px;" method="POST">
       Qty
<select style="width:50px; height30x;" name = " dropdown">   
...
if(isset($_POST['additems'])){
        ...
        $sql="INSERT INTO cart(userid,frequency,amount,crops_id) values('$idd','$frequency','$amount','$id')";
        mysqli_query($db,$sql);
