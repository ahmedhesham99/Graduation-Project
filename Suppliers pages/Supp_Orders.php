...
<button  style= margin-left:80%; type="button" class="back_btn"><a style="color:red;text-decoration:none;" href="crops.php">Back to previous page</a></button>
...
$query=" SELECT * FROM supp_order_total WHERE user =$id ORDER BY date DESC";
...
<tr style="color:white;font-size:25px;">
 ...
 <td> <a style="color:red;text-decoration:none;" href="sorderdetails.php?id=<?php echo $data['id'];?>" >View</a> <td>
