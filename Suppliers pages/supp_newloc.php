...
<?php endif ?>  
        ...
        <div class="main_container">
            <h1 style="font-size:35px;font-family:arial">Add Location</h1>
        <div class="row">
            
            <form class="row g-3" method="POST" enctype="multipart/form-data">
                <div class="col-12 ">
                    <label style="font-size:25px" for="inputuname" class="form-label"> New Location</label>
                    <input type="text" class="form-control"  aria-label="username"name="loc"required>
                  </div>
 ...
 $loc=$_POST['loc'];
     ...
     $sql2="INSERT INTO supp_location(location,sid) values('$loc','$id')";
