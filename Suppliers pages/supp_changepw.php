...
$qry1 = mysqli_query($db,"SELECT * FROM suppliers WHERE id ='$id'");
...
if(isset($_POST['update'])){
    ...
    if(count($error)==0){
        ...
        $sql="UPDATE suppliers SET password='$pw1'  WHERE id ='$id'";
...
<h3 class="title"> "Change your Password" </h3>
 <button  style= "margin-left:80%;width:300px;height:40px" type="button" class="back_btn"><a style="color:red;text-decoration:none;" href="supp_profile.php">Back to previous page</a></button>
