...
<html lang="en">
<head>
<?php include('server.php'); if (isset($_SESSION['id'])){?>
    <meta charset="UTF-8">
...
<header  class=fertilizers>  <a style="text-decoration:none;" href="fertilizers.php"><h1> Fertilizers </h1> </a> <br><br>
<nav class="navbar navbar-expand-lg bg-light">
  <div class="container-fluid">
    <a style="color:green" class="navbar-brand" href="dist_profile.php">Myprofile</a>
    ...
    <div class="collapse navbar-collapse" id="navbarNav">
      <ul class="navbar-nav">
        <li class="nav-item">
          <a style="color:green" class="nav-link active" aria-current="page" href="dist_Orders.php">My orders</a>
        </li>
        <li class="nav-item">
          <a style="color:green" class="nav-link" href="cartd.php">Cart</a>
        </li>
  ...
  <a class="btn btn-success" href="fertilizers.php?logout='1'">Logout</a>
...
<br>
<a class=" add-cart cart1" href="inspectd.php?id=<?php echo$result['id'];?>">Add cart</a> <br> <br> <br>
...
$product="SELECT * FROM fertilizers";
